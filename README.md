...
## Project
 - Guidelines: [https://bitbucket.org/neuedamats/portfoliomanager/src/additional_projects/README.md](https://bitbucket.org/neuedamats/portfoliomanager/src/additional_projects/README.md)
...
## Day 2 Linux & Vi
 - [https://github.com/ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) Empower your terminal
 - [https://explainshell.com](https://explainshell.com): Breaks down shell commands visually
 - [https://labex.io/linuxjourney](https://labex.io/linuxjourney): Free beginner-friendly tutorials
 - [https://openvim.com/](https://openvim.com/): Interactive Vim Learning
 - [https://vim-adventures.com/](https://vim-adventures.com/): Learning vim with a game

## Day 3 SQL
 - [https://mystery.knightlab.com/](https://mystery.knightlab.com/) Solve a murder mystery using SQL queries on real database tables  
- [http://wwwlgis.informatik.uni-kl.de/extra/game/?lang=en](http://wwwlgis.informatik.uni-kl.de/extra/game/?lang=en) Learn SQL through a fun survival adventure game on an island  
- [https://sqlpd.com/](https://sqlpd.com/) Crack criminal cases by writing SQL queries and analyzing data  
- [https://codepip.com/games/querymon/](https://codepip.com/games/querymon/) A Pokémon-style game to learn SQL concepts interactively  
- [https://www.sqlzoo.net/](https://www.sqlzoo.net/) Hands-on SQL tutorials with real-time query practice  
- [https://kahoot.com/](https://kahoot.com/) Create live quiz-based games to test database concepts in class  
